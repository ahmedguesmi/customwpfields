...
class Location implements Field {
    ...
    public static function render( array $field = [] ): void {
        ...
        // Retrieve scripts
        if( apply_filters('customwpfields_location_field_js', true) && ! wp_script_is('google-maps-js', 'enqueued') ) {
    ...
    public static function configurations(): array {
        ...
        return apply_filters( 'customwpfields_location_config', $configurations );
    }
