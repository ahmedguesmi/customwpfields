...
class Datepicker implements Field {
    ...
    public static function render( array $field = [] ): void {
        ...
        if( apply_filters('customwpfields_datepicker_field_js', true) && ! wp_script_is('flatpicker-js', 'enqueued') ) {
    ...
    public static function configurations(): array {
        ...
        return apply_filters( 'customwpfields_datepicker_config', $configurations );
