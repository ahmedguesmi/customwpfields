...
class Meta {
    ...
    public function render( $object ) {
        ...
        $frame->settings_fields = wp_nonce_field( 'customwpfields-metaboxes-' . $frame->id, 'customwpfields-metaboxes-nonce-' . $frame->id, true, false );
    ...
    public function save( $id ) {
        ...
        if( ! isset($_POST['customwpfields-metaboxes-nonce-' . $this->meta_box['id']]) ) {
            return;
        }
        ...
        // Check our nonces
        if( ! wp_verify_nonce( $_POST['customwpfields-metaboxes-nonce-' . $this->meta_box['id']], 'customwpfields-metaboxes-' . $this->meta_box['id'] ) ) {
            return;
        }
