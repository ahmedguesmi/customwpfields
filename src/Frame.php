...
use Ahmedguesmi\Customwpfields\Framework as Framework;
...
class Frame {
    ...
    public function __construct( Array $frame, $values = '' ) {
        ...
        if( ! wp_script_is('customwpfields-js') ) {
            wp_enqueue_script('customwpfields-js');  
        }       
    ...
    private function populate_sections(): void {
        ...
        // Current section
        $transient              = get_transient( 'customwpfields_current_section_' . $this->frame['id'] );
    ...
    private function populate_field( array $field = [] ): array {
        ...
        // The class
        $class                  = apply_filters( 'customwpfields_field_class', 'Ahmedguesmi\Customwpfields\Fields\\' . ucfirst( $field['type'] ), $field );
        ...
        if( class_exists($class) ) {
            ...
            $field['form']      = apply_filters( 'customwpfields_field_form', $form, $field );
    ...
    public function render(): void {
        ...
        if( empty($this->sections) ) {
            require( CUSTOMWPFIELDS_PATH . '/templates/nothing.php' );
            return;
        } 
        ...
        // Render the frame
        require( CUSTOMWPFIELDS_PATH . '/templates/frame.php' );
