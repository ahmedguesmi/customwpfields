   ...
   /**
    ...
    public function output_CSS(): void {
        ...
        foreach( $this->fields as $key => $field ) {
            ...
            $properties = apply_filters( 'customwpfields_css_properties', $properties, $field ); 
    ...
    public function custom_fonts(): void {
        ...
        // Enqueue the styles.
        if( $styles ) {
            wp_enqueue_style( 'customwpfields-fonts', 'https://fonts.googleapis.com/css?family=' . implode('|', $styles) );
        }
    ...
    public function customizer_JS(): void {
        ...
        add_action('wp_footer', function() {
            ...
            // Our bindings script
            if( $script ) {
                echo '<script type="text/javascript" id="customwpfields-customizer-js">( function( $ ) {' . $script . '} )( jQuery );</script>';
            }
